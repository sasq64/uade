 ...
 */
int _wreaddir_r(_WDIR* dirp, struct _wdirent* entry,
...
DIR* opendir(const char* dirname)
{
    ...
    if (dirp) {
        ...
        error =
            dirent_mbstowcs_s(&n, wname, PATH_MAX + 1, dirname, PATH_MAX + 1);
        if (!error) {
...
int dirent_mbstowcs_s(size_t* pReturnValue, wchar_t* wcstr,
